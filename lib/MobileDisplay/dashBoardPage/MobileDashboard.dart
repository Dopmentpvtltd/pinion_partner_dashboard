...
import 'package:login/Dashboard_buttons/_communicationTipsContent.dart';
import 'package:country_list_pick/country_list_pick.dart';
import 'package:login/MobileDisplay/dashBoardPage/MobPackages.dart';
import 'package:login/MobileDisplay/dashBoardPage/MobPRDashboard.dart.dart';
// import 'package:login/Fotters/MTFotter.dart';
...
class _MobileDashboardPageState extends State<MobileDashboardPage> {
  ...
  String _selectedButton = 'packages';
          ...
          Row(
            ...
            children: [
              PopupMenuButton<String>(
                ...
                offset: Offset(0, 90), // Offset from the icon's position
                  ...
                  return [
                    PopupMenuItem<String>(
                      ...
                      child: Container(
                        ...
                        width: 400, // Width of the menu item
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _dashboardButton('user_profile', 'User Profile',
                                    Icons.person),
                                SizedBox(height: 10.0),
                                _dashboardButton('pr_dashboard',
                                    'Submit Your PR', Icons.dashboard),
                                SizedBox(height: 10.0),
                  ...
                  child: Row(
                    children: [
                      Icon(
                        ...
                        color: _isHovered
                            ? Color(0xFF0D47A1)
                            : Color(0xFF0D47A1), // Change color on hover
                      ),
                      SizedBox(width: 5),
                      Text(
                        "Sign Out",
  ...
  Widget _displayContent() {
    switch (_selectedButton) {
      ...
      case 'pr_dashboard':
        return Center(
          child: MobPRDashboard(),
        );
      case 'communication_tips':
        return communicationTipsContent();
      case 'packages':
        return MTPAckages();
      default:
        return Container();
